...
$datacheckbox1 = ['0'=>'-Kosong-','1'=>'Manual Input','2'=>'Kode Jenis Bahan','3'=>'Kode Kategori Koleksi','4'=>'Kode Bentuk Fisik','5'=>'Kode Jenis Sumber Pengadaan'];
...
// print_r($FormatNomorInduksx[2]);echo '<br />';
// print_r($FormatNomorInduks[5]);echo '<br />';
...
if($FormatNomorInduksx[4] == 1)
{
    ...
    $dataTemplateInput2=trim(str_replace('}','',str_replace('{','',$FormatNomorInduks[4])));
...
if($FormatNomorInduksx[8] == 1)
{
    ...
    $dataTemplateInput3=trim(str_replace('}','',str_replace('{','',$FormatNomorInduks[8])));
            ...
            <div class="col-sm-12">
              <div class="form-group">
                  <label class="control-label col-sm-2" for="email"><?php echo Html::label(Yii::t('app', 'Middle Induk Number')); ?></label>
                        <div class="col-sm-2" style="width:13%; margin-right:-12px;">
                        <?php 
                        echo Select2::widget([
                                'id' => 'cbTemplate1',
                                'name' => 'cbTemplate[]',
                        ...
                        echo Html::hiddenInput('cbTemplateInput[51]', 'dump');
                        ...
                        echo Html::textInput('cbTemplateInput[4]',$dataTemplateInput2,['id'=>'cbTemplateInput4','class'=>'form-control manualinp','style'=>$display2.'width:100%']);
                        ...
                        echo Html::textInput('cbTemplateInput[8]',$dataTemplateInput3,['id'=>'cbTemplateInput8','class'=>'form-control manualinp','style'=>$display3.'width:100%']);
