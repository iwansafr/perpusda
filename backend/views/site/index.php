...
$this->title = yii::t('app','Beranda');
$this->params['breadcrumbs'][] = (Yii::$app->config->get('KodeRegistrasi') == '') ? ['label' => yii::t('app','Aplikasi ini belum diregistrasikan. Klik di sini untuk informasi lebih lengkap'), 'url' => Url::to(['setting/umum/registrasi/'])] : ['label' => yii::t('app','Aplikasi ini telah teregistrasi untuk ').Yii::$app->config->get('NamaPerpustakaan')] ;
